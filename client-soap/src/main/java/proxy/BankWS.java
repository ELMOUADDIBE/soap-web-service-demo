 ...
 * 
 */
@WebServiceClient(name = "BankWS", targetNamespace = "http://enset.ma/", wsdlLocation = "http://localhost:9090/bank?wsdl")
public class BankWS
    extends Service
{
    ...
    private static final QName BANKWS_QNAME = new QName("http://enset.ma/", "BankWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9090/bank?wsdl");
