...
public class ObjectFactory {
    ...
    private static final QName _ListComptes_QNAME = new QName("http://enset.ma/", "listComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://enset.ma/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://enset.ma/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://enset.ma/", name = "listComptesResponse")
